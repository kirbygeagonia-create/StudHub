...
enum Badge: string
{
    ...
    public function category(): BadgeCategory
    {
        return match ($this) {
            ...
            self::ContentMill, self::CrossPollinator, self::LegacyHolder
                => BadgeCategory::Upload,

            self::FirstResponder, self::RequestSlayer, self::DemandAndSupply,
            self::TheFixer, self::SignalBoost, self::BridgeBuilder
                => BadgeCategory::Fulfill,
    ...
    public function rarity(): BadgeRarity
    {
        return match ($this) {
            ...
            self::GenerousSoul, self::Chatterbox
                => BadgeRarity::Common,
            ...
            self::EarlyBird, self::NightOwl, self::DailyDevotee,
            self::ThreadStarter, self::TheConnector, self::RoomRegular
            ...
            self::HabitFormer, self::SemesterStrong, self::QuickDraw
                => BadgeRarity::Rare,
