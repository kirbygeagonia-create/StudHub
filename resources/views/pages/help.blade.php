        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <div class="space-y-4 text-sm text-gray-600">
                    <div>
                        <h4 class="font-medium text-gray-800 mb-1">1. Complete your onboarding</h4>
                    ...
                    <div>
                        <h4 class="font-medium text-gray-800 mb-1">2. Post a resource</h4>
                    ...
                    <div>
                        <h4 class="font-medium text-gray-800 mb-1">3. Make a request</h4>
                    ...
                    <div>
                        <h4 class="font-medium text-gray-800 mb-1">4. Use chat</h4>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">How to Ask for Resources</h3>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Karma &amp; Badges</h3>
                <div class="space-y-2 text-sm text-gray-600">
                    ...
                    <p class="mt-3">Badge tiers: <span class="text-yellow-700 font-medium">Bronze</span> at 25 karma, <span class="text-gray-400 font-medium">Silver</span> at 75, <span class="text-amber-500 font-medium">Gold</span> at 150.</p>
                </div>
            </div>
