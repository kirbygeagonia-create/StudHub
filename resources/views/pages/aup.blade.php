<x-guest-layout>
    <div class="text-center mb-6">
        <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">Acceptable Use Policy</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Effective date: {{ now()->format('F Y') }}</p>
    </div>
