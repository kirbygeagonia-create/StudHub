            ...
            <div class="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4">
                @if (session('status') || session('success'))
                    <div x-data="{ flashShow: true }" x-show="flashShow" x-init="setTimeout(() => flashShow = false, 4000)"
                        ...
                        <button @click="flashShow = false" class="ml-auto text-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-300" aria-label="Dismiss notification"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button>
                    </div>
                @endif
                @if (session('error'))
                    <div x-data="{ flashShow: true }" x-show="flashShow" x-init="setTimeout(() => flashShow = false, 5000)"
                        ...
                        <button @click="flashShow = false" class="ml-auto text-red-500 hover:text-red-700 dark:hover:text-red-300" aria-label="Dismiss notification"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button>
                    </div>
                @endif
                @if (session('warning'))
                    <div x-data="{ flashShow: true }" x-show="flashShow" x-init="setTimeout(() => flashShow = false, 6000)"
                        ...
                        <button @click="flashShow = false" class="ml-auto text-amber-500 hover:text-amber-700 dark:hover:text-amber-300" aria-label="Dismiss notification"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button>
                    </div>
                @endif
                @if (session('info'))
                    <div x-data="{ flashShow: true }" x-show="flashShow" x-init="setTimeout(() => flashShow = false, 5000)"
                        ...
                        <button @click="flashShow = false" class="ml-auto text-blue-500 hover:text-blue-700 dark:hover:text-blue-300" aria-label="Dismiss notification"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button>
                    </div>
                @endif
            </div>
        @endif
