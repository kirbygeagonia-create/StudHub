<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 mt-2">
        <a href="{{ route('requests.index') }}" class="inline-flex items-center gap-1 text-xs text-gray-400 hover:text-seait-500 dark:hover:text-seait-400 transition-colors">
